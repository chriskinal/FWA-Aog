...
public:
	ImuRvc(JsonDB* _db, uint8_t _port=1, uint8_t _axisOrientation=1){
		db = _db;
    ...
    double y  =(double)(y0 - ((buffer[2]>127)? 65536 : 0)) * conv - (my % m2pi)/1000;
    double p=(double)(p0 - ((buffer[4]>127)? 65536 : 0)) * conv - (mp % m2pi)/1000;
    double r =(double)(r0 - ((buffer[6]>127)? 65536 : 0)) * conv - (mr % m2pi)/1000;
